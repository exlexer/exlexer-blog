...
/* harmony import */ var next_dist_build_webpack_loaders_next_serverless_loader_page_handler__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(9436);
      ...
      const appMod = __webpack_require__(5108)
      let App = appMod.default || appMod.then && appMod.then(mod => mod.default);

      const compMod = __webpack_require__(5063)
      ...
      const { renderReqToHTML, render } = (0,next_dist_build_webpack_loaders_next_serverless_loader_page_handler__WEBPACK_IMPORTED_MODULE_4__/* .getPageHandler */ .u)({
        ...
        i18n: undefined,
        page: "/post/[slug]",
        buildId: "vQrU7ix9aUhSwM60jOBSs",
        escapedBuildId: "vQrU7ix9aUhSwM60jOBSs",
        basePath: "",
        pageIsDynamic: true,
        encodedPreviewProps: {previewModeId:"33cfa3c7c8277e1fbf96daf3820d690a",previewModeSigningKey:"1f0fc593978bfcfa77f5a5cb652eaf82d697fb0065af6eb60c828c2d9fff8406",previewModeEncryptionKey:"ad91f433b532a9598e1c38fadf6f460cfd657b7cfb6a3141411973d9b6503f2b"}
      })
...
/* harmony import */ var markdown_it__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9980);
...
async function getStaticProps({ params: { slug  }  }) {
    const fileName = fs__WEBPACK_IMPORTED_MODULE_1___default().readFileSync(`posts/${slug}.md`, "utf8");
...
var __webpack_exports__ = __webpack_require__.X(0, [307,675,980,444], () => (__webpack_exec__(483)));
